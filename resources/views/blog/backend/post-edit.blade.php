...
<input type="text" class="form-control" style="width:50px;" name="attachment_{{ $attachment->id }}" value="{{ $attachment->short }}"><br /><br />
@endforeach
<div id="status"></div>
...
<input type="text" name="konten" value="{{$result->konten}}" class="form-control" placeholder="Caption"><br>
